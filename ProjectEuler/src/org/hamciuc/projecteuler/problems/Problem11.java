...
public class Problem11 {
	static int[][]array = {{8, 02, 22, 97, 38, 15, 00, 40, 00, 75, 04, 05, 07, 78, 52, 12, 50, 77, 91, 8},
	...
	public static void main(String[] args) {
		...
		for(int i=0;i<array.length;i++) {
			...
			for(int j=0;j<array[i].length-3;j++) {
				//horizontal
				long current = array[i][j]*array[i][j+1]*array[i][j+2]*array[i][j+3];
		...
		for(int i=0;i<array.length-3;i++) {
			for(int j=0;j<array.length-3;j++){
				long current = array[i][j]*array[i+1][j+1]*array[i+2][j+2]*array[i+3][j+3];
				if(current>maxProduct) {
					maxProduct = current;
				}
			}
